...
#' @description Function to Get all persons from pipedrive.
#' @param user_id If supplied, only persons owned by the given user will be returned.
#' @param filter_id ID of the filter to use
#' @param first_char If supplied, only persons whose name starts with the specified letter will be returned (case insensitive).
...
#' }
persons.get_all <- function(user_id=NULL, filter_id=NULL, first_char=NULL, start=NULL, limit=NULL, sort=NULL, api_token=NULL, company_domain='api'){
