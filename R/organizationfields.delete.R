...
#' @description Function to Delete an organization field on pipedrive.
...
#' @export
#' @examples \donttest{
#' organizationfields.delete(id='e.g.',api_token='token',company_domain='exp')
#' }
organizationfields.delete <- function(id, api_token=NULL, company_domain='api', return_type = c('complete','boolean')){
