#' @title Delete a permission set assignment
#' @description Function to Delete a permission set assignment on pipedrive.
...
#' @export
#' @examples \donttest{
#' permissionsets.delete(id='e.g.',user_id='e.g.',api_token='token',company_domain='exp')
#' }
permissionsets.delete <- function(id, user_id, api_token=NULL, company_domain='api', return_type = c('complete','boolean')){
