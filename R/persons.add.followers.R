...
#' @description Function to Add a follower to a person on pipedrive.
...
#' @export
#' @examples \donttest{
#' persons.add.followers(id='e.g.',user_id='e.g.',api_token='token',company_domain='exp')
#' }
persons.add.followers <- function(id, user_id, api_token=NULL, company_domain='api', return_type = c('complete','boolean')){
