...
#' @description Function to List role assignments from pipedrive.
...
#' @export
#' @examples \donttest{
#' users.get.roleassignments(id='e.g.',api_token='token',company_domain='exp')
#' }
users.get.roleassignments <- function(id, start=NULL, limit=NULL, api_token=NULL, company_domain='api'){
