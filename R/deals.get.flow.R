...
#' @description Function to List updates about a deal from pipedrive.
...
#' @export
#' @examples \donttest{
#' deals.get.flow(id='e.g.',api_token='token',company_domain='exp')
#' }
deals.get.flow <- function(id, start=NULL, limit=NULL, api_token=NULL, company_domain='api'){
api_token <- check_api_token_(api_token)
url <- 'https://{company_domain}.pipedrive.com/v1/deals/{id}/flow?'
