#' @title Add permission set assignment
#' @description Function to Add permission set assignment on pipedrive.
...
#' @export
#' @examples \donttest{
#' permissionsets.add(id='e.g.',user_id='e.g.',api_token='token',company_domain='exp')
#' }
permissionsets.add <- function(id, user_id, api_token=NULL, company_domain='api', return_type = c('complete','boolean')){
