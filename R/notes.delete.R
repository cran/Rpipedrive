#' @title Delete a note
#' @description Function to Delete a note on pipedrive.
...
#' @export
#' @examples \donttest{
#' notes.delete(id='e.g.',api_token='token',company_domain='exp')
#' }
notes.delete <- function(id, api_token=NULL, company_domain='api', return_type = c('complete','boolean')){
