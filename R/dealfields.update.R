...
#' @description Function to Update a deal field on pipedrive.
...
#' @export
#' @examples \donttest{
#' dealfields.update(id='e.g.',name='e.g.',api_token='token',company_domain='exp')
#' }
dealfields.update <- function(id, name, options=NULL, api_token=NULL, company_domain='api', return_type = c('complete','boolean')){
api_token <- check_api_token_(api_token)
url <- 'https://{company_domain}.pipedrive.com/v1/dealFields/{id}?'
