...
#' @description Function to Get one mail thread from pipedrive.
...
#' @export
#' @examples \donttest{
#' mailthreads.get(id='e.g.',api_token='token',company_domain='exp')
#' }
mailthreads.get <- function(id, api_token=NULL, company_domain='api'){
