...
#' @description Function to Delete a deal field on pipedrive.
...
#' @export
#' @examples \donttest{
#' dealfields.delete(id='e.g.',api_token='token',company_domain='exp')
#' }
dealfields.delete <- function(id, api_token=NULL, company_domain='api', return_type = c('complete','boolean')){
