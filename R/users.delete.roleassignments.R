...
#' @export
#' @examples \donttest{
#' users.delete.roleassignments(id='e.g.',role_id='e.g.',api_token='token',company_domain='exp')
#' }
users.delete.roleassignments <- function(id, role_id, api_token=NULL, company_domain='api', return_type = c('complete','boolean')){
