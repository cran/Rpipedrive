...
#' @export
#' @examples \donttest{
#' persons.get.permittedusers(id='e.g.',api_token='token',company_domain='exp')
#' }
persons.get.permittedusers <- function(id, access_level=NULL, api_token=NULL, company_domain='api'){
