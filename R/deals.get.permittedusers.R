...
#' @export
#' @examples \donttest{
#' deals.get.permittedusers(id='e.g.',api_token='token',company_domain='exp')
#' }
deals.get.permittedusers <- function(id, access_level=NULL, api_token=NULL, company_domain='api'){
api_token <- check_api_token_(api_token)
url <- 'https://{company_domain}.pipedrive.com/v1/deals/{id}/permittedUsers?'
