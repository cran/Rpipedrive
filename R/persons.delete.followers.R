...
#' @description Function to Delete a follower from a person on pipedrive.
...
#' @export
#' @examples \donttest{
#' persons.delete.followers(id='e.g.',follower_id='e.g.',api_token='token',company_domain='exp')
#' }
persons.delete.followers <- function(id, follower_id, api_token=NULL, company_domain='api', return_type = c('complete','boolean')){
