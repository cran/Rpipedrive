#' @title Delete a role
#' @description Function to Delete a role on pipedrive.
...
#' @export
#' @examples \donttest{
#' roles.delete(id='e.g.',api_token='token',company_domain='exp')
#' }
roles.delete <- function(id, api_token=NULL, company_domain='api', return_type = c('complete','boolean')){
