...
#' @description Function to Delete a follower from an organization on pipedrive.
...
#' }
organizations.delete.followers <- function(id, follower_id, api_token=NULL, company_domain='api', return_type = c('complete','boolean')){
api_token <- check_api_token_(api_token)
url <- 'https://{company_domain}.pipedrive.com/v1/organizations/{id}/followers/{follower_id}?'
