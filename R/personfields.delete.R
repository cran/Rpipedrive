...
#' @description Function to Delete a person field on pipedrive.
...
#' @export
#' @examples \donttest{
#' personfields.delete(id='e.g.',api_token='token',company_domain='exp')
#' }
personfields.delete <- function(id, api_token=NULL, company_domain='api', return_type = c('complete','boolean')){
