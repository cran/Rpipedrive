...
#' @description Function to Delete a filter on pipedrive.
...
#' @export
#' @examples \donttest{
#' filters.delete(id='e.g.',api_token='token',company_domain='exp')
#' }
filters.delete <- function(id, api_token=NULL, company_domain='api', return_type = c('complete','boolean')){
