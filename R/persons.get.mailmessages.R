...
#' @description Function to List mail messages associated with a person from pipedrive.
...
#' @export
#' @examples \donttest{
#' persons.get.mailmessages(id='e.g.',api_token='token',company_domain='exp')
#' }
persons.get.mailmessages <- function(id, start=NULL, limit=NULL, api_token=NULL, company_domain='api'){
