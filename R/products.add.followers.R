...
#' @description Function to Add a follower to a product on pipedrive.
...
#' @export
#' @examples \donttest{
#' products.add.followers(id='e.g.',user_id='e.g.',api_token='token',company_domain='exp')
#' }
products.add.followers <- function(id, user_id, api_token=NULL, company_domain='api', return_type = c('complete','boolean')){
api_token <- check_api_token_(api_token)
url <- 'https://{company_domain}.pipedrive.com/v1/products/{id}/followers?'
