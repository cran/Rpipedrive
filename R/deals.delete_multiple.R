...
#' @description Function to Delete multiple deals in bulk on pipedrive.
...
#' @export
#' @examples \donttest{
#' deals.delete_multiple(ids='e.g.',api_token='token',company_domain='exp')
#' }
deals.delete_multiple <- function(ids, api_token=NULL, company_domain='api', return_type = c('complete','boolean')){
