...
#' @description Function to List permission set assignments from pipedrive.
...
#' @export
#' @examples \donttest{
#' permissionsets.get.assignments(id='e.g.',api_token='token',company_domain='exp')
#' }
permissionsets.get.assignments <- function(id, start=NULL, limit=NULL, api_token=NULL, company_domain='api'){
