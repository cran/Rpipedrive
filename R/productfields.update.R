...
#' @description Function to Update a product field on pipedrive.
...
#' }
productfields.update <- function(id, name, options=NULL, api_token=NULL, company_domain='api', return_type = c('complete','boolean')){
