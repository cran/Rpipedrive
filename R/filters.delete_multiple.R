...
#' @description Function to Delete multiple filters in bulk on pipedrive.
...
#' @export
#' @examples \donttest{
#' filters.delete_multiple(ids='e.g.',api_token='token',company_domain='exp')
#' }
filters.delete_multiple <- function(ids, api_token=NULL, company_domain='api', return_type = c('complete','boolean')){
