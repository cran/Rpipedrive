...
#' @description Function to Dismiss a global message on pipedrive.
...
#' @export
#' @examples \donttest{
#' globalmessages.delete(id='e.g.',api_token='token',company_domain='exp')
#' }
globalmessages.delete <- function(id, api_token=NULL, company_domain='api', return_type = c('complete','boolean')){
api_token <- check_api_token_(api_token)
url <- 'https://{company_domain}.pipedrive.com/v1/globalMessages/{id}?'
