...
#' @description Function to Delete an organization on pipedrive.
...
#' @export
#' @examples \donttest{
#' organizations.delete(id='e.g.',api_token='token',company_domain='exp')
#' }
organizations.delete <- function(id, api_token=NULL, company_domain='api', return_type = c('complete','boolean')){
