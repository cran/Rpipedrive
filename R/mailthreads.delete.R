...
#' @description Function to Delete mail thread on pipedrive.
...
#' @export
#' @examples \donttest{
#' mailthreads.delete(id='e.g.',api_token='token',company_domain='exp')
#' }
mailthreads.delete <- function(id, api_token=NULL, company_domain='api', return_type = c('complete','boolean')){
