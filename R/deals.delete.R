#' @title Delete a deal
#' @description Function to Delete a deal on pipedrive.
...
#' @export
#' @examples \donttest{
#' deals.delete(id='e.g.',api_token='token',company_domain='exp')
#' }
deals.delete <- function(id, api_token=NULL, company_domain='api', return_type = c('complete','boolean')){
