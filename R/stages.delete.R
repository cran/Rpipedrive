...
#' @description Function to Delete a stage on pipedrive.
...
#' @export
#' @examples \donttest{
#' stages.delete(id='e.g.',api_token='token',company_domain='exp')
#' }
stages.delete <- function(id, api_token=NULL, company_domain='api', return_type = c('complete','boolean')){
