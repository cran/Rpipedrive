...
#' @description Function to List role sub-roles from pipedrive.
...
#' @export
#' @examples \donttest{
#' roles.get.roles(id='e.g.',api_token='token',company_domain='exp')
#' }
roles.get.roles <- function(id, start=NULL, limit=NULL, api_token=NULL, company_domain='api'){
api_token <- check_api_token_(api_token)
url <- 'https://{company_domain}.pipedrive.com/v1/roles/{id}/roles?'
