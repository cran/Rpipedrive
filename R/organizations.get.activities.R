...
#' @description Function to List activities associated with an organization from pipedrive.
...
#' @export
#' @examples \donttest{
#' organizations.get.activities(id='e.g.',api_token='token',company_domain='exp')
#' }
organizations.get.activities <- function(id, start=NULL, limit=NULL, done=NULL, exclude=NULL, api_token=NULL, company_domain='api'){
api_token <- check_api_token_(api_token)
url <- 'https://{company_domain}.pipedrive.com/v1/organizations/{id}/activities?'
