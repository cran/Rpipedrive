...
#' @description Function to List all persons associated with a deal from pipedrive.
...
#' @export
#' @examples \donttest{
#' deals.get.persons(id='e.g.',api_token='token',company_domain='exp')
#' }
deals.get.persons <- function(id, start=NULL, limit=NULL, api_token=NULL, company_domain='api'){
api_token <- check_api_token_(api_token)
url <- 'https://{company_domain}.pipedrive.com/v1/deals/{id}/persons?'
