...
#' @description Function to Update a person field on pipedrive.
...
#' @export
#' @examples \donttest{
#' personfields.update(id='e.g.',name='e.g.',api_token='token',company_domain='exp')
#' }
personfields.update <- function(id, name, options=NULL, api_token=NULL, company_domain='api', return_type = c('complete','boolean')){
