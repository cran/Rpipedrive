...
#' @description Function to Delete a follower from a deal on pipedrive.
...
#' @export
#' @examples \donttest{
#' deals.delete.followers(id='e.g.',follower_id='e.g.',api_token='token',company_domain='exp')
#' }
deals.delete.followers <- function(id, follower_id, api_token=NULL, company_domain='api', return_type = c('complete','boolean')){
api_token <- check_api_token_(api_token)
url <- 'https://{company_domain}.pipedrive.com/v1/deals/{id}/followers/{follower_id}?'
