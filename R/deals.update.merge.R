...
#' @description Function to Merge two deals on pipedrive.
...
#' @export
#' @examples \donttest{
#' deals.update.merge(id='e.g.',merge_with_id='e.g.',api_token='token',company_domain='exp')
#' }
deals.update.merge <- function(id, merge_with_id, api_token=NULL, company_domain='api', return_type = c('complete','boolean')){
api_token <- check_api_token_(api_token)
url <- 'https://{company_domain}.pipedrive.com/v1/deals/{id}/merge?'
