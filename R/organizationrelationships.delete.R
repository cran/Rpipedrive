...
#' @description Function to Delete an organization relationship on pipedrive.
...
#' @export
#' @examples \donttest{
#' organizationrelationships.delete(id='e.g.',api_token='token',company_domain='exp')
#' }
organizationrelationships.delete <- function(id, api_token=NULL, company_domain='api', return_type = c('complete','boolean')){
