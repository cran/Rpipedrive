...
#' @description Function to Delete multiple organizations in bulk on pipedrive.
...
#' @export
#' @examples \donttest{
#' organizations.delete_multiple(ids='e.g.',api_token='token',company_domain='exp')
#' }
organizations.delete_multiple <- function(ids, api_token=NULL, company_domain='api', return_type = c('complete','boolean')){
