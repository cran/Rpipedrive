...
#' @description Function to Delete an activity type on pipedrive.
...
#' @export
#' @examples \donttest{
#' activitytypes.delete(id='e.g.',api_token='token',company_domain='exp')
#' }
activitytypes.delete <- function(id, api_token=NULL, company_domain='api', return_type = c('complete','boolean')){
