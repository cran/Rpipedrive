...
#' @description Function to Delete multiple persons in bulk on pipedrive.
...
#' @export
#' @examples \donttest{
#' persons.delete_multiple(ids='e.g.',api_token='token',company_domain='exp')
#' }
persons.delete_multiple <- function(ids, api_token=NULL, company_domain='api', return_type = c('complete','boolean')){
