...
#' @description Function to Merge two organizations on pipedrive.
...
#' }
organizations.update.merge <- function(id, merge_with_id, api_token=NULL, company_domain='api', return_type = c('complete','boolean')){
