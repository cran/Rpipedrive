...
#' @description Function to Delete a product on pipedrive.
...
#' @export
#' @examples \donttest{
#' products.delete(id='e.g.',api_token='token',company_domain='exp')
#' }
products.delete <- function(id, api_token=NULL, company_domain='api', return_type = c('complete','boolean')){
