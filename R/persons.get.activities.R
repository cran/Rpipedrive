...
#' @description Function to List activities associated with a person from pipedrive.
...
#' }
persons.get.activities <- function(id, start=NULL, limit=NULL, done=NULL, exclude=NULL, api_token=NULL, company_domain='api'){
