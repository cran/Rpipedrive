...
#' @description Function to Add a new product field on pipedrive.
...
#' }
productfields.add <- function(name, field_type, options=NULL, api_token=NULL, company_domain='api', return_type = c('complete','boolean')){
