...
#' @description Function to List files attached to a deal from pipedrive.
...
#' @export
#' @examples \donttest{
#' deals.get.files(id='e.g.',api_token='token',company_domain='exp')
#' }
deals.get.files <- function(id, start=NULL, limit=NULL, include_deleted_files=NULL, sort=NULL, api_token=NULL, company_domain='api'){
api_token <- check_api_token_(api_token)
url <- 'https://{company_domain}.pipedrive.com/v1/deals/{id}/files?'
