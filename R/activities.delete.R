...
#' @description Function to Delete an activity on pipedrive.
...
#' @export
#' @examples \donttest{
#' activities.delete(id='e.g.',api_token='token',company_domain='exp')
#' }
activities.delete <- function(id, api_token=NULL, company_domain='api', return_type = c('complete','boolean')){
