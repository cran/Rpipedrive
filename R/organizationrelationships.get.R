...
#' @description Function to Get one organization relationship from pipedrive.
...
#' @export
#' @examples \donttest{
#' organizationrelationships.get(id='e.g.',api_token='token',company_domain='exp')
#' }
organizationrelationships.get <- function(id, org_id=NULL, api_token=NULL, company_domain='api'){
api_token <- check_api_token_(api_token)
url <- 'https://{company_domain}.pipedrive.com/v1/organizationRelationships/{id}?'
bodyList <- list(id=id,org_id=org_id)
