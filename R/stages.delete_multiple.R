...
#' @description Function to Delete multiple stages in bulk on pipedrive.
...
#' }
stages.delete_multiple <- function(ids, api_token=NULL, company_domain='api', return_type = c('complete','boolean')){
