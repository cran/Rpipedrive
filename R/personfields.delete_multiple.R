...
#' @description Function to Delete multiple person fields in bulk on pipedrive.
...
#' @export
#' @examples \donttest{
#' personfields.delete_multiple(ids='e.g.',api_token='token',company_domain='exp')
#' }
personfields.delete_multiple <- function(ids, api_token=NULL, company_domain='api', return_type = c('complete','boolean')){
