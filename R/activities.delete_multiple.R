...
#' @description Function to Delete multiple activities in bulk on pipedrive.
...
#' @export
#' @examples \donttest{
#' activities.delete_multiple(ids='e.g.',api_token='token',company_domain='exp')
#' }
activities.delete_multiple <- function(ids, api_token=NULL, company_domain='api', return_type = c('complete','boolean')){
