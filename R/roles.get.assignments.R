...
#' @export
#' @examples \donttest{
#' roles.get.assignments(id='e.g.',api_token='token',company_domain='exp')
#' }
roles.get.assignments <- function(id, start=NULL, limit=NULL, api_token=NULL, company_domain='api'){
