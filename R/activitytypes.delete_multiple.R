...
#' @description Function to Delete multiple activity types in bulk on pipedrive.
...
#' @export
#' @examples \donttest{
#' activitytypes.delete_multiple(ids='e.g.',api_token='token',company_domain='exp')
#' }
activitytypes.delete_multiple <- function(ids, api_token=NULL, company_domain='api', return_type = c('complete','boolean')){
