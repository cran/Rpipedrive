...
#' @description Function to Update file details on pipedrive.
#' @param id ID of the file
#' @param name Visible name of the file
...
#' @export
#' @examples \donttest{
#' files.update(id='e.g.',api_token='token',company_domain='exp')
#' }
files.update <- function(id, name=NULL, description=NULL, api_token=NULL, company_domain='api', return_type = c('complete','boolean')){
api_token <- check_api_token_(api_token)
url <- 'https://{company_domain}.pipedrive.com/v1/files/{id}?'
bodyList <- list(id=id,name=name,description=description)
