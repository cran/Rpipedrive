...
#' @description Function to Delete multiple product fields in bulk on pipedrive.
...
#' @export
#' @examples \donttest{
#' productfields.delete_multiple(ids='e.g.',api_token='token',company_domain='exp')
#' }
productfields.delete_multiple <- function(ids, api_token=NULL, company_domain='api', return_type = c('complete','boolean')){
api_token <- check_api_token_(api_token)
url <- 'https://{company_domain}.pipedrive.com/v1/productFields?'
