...
#' @description Function to Delete a pipeline on pipedrive.
...
#' @export
#' @examples \donttest{
#' pipelines.delete(id='e.g.',api_token='token',company_domain='exp')
#' }
pipelines.delete <- function(id, api_token=NULL, company_domain='api', return_type = c('complete','boolean')){
