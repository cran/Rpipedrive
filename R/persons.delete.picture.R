...
#' @description Function to Delete person picture on pipedrive.
...
#' @export
#' @examples \donttest{
#' persons.delete.picture(id='e.g.',api_token='token',company_domain='exp')
#' }
persons.delete.picture <- function(id, api_token=NULL, company_domain='api', return_type = c('complete','boolean')){
