...
#' @export
#' @examples \donttest{
#' roles.add.assignments(id='e.g.',user_id='e.g.',api_token='token',company_domain='exp')
#' }
roles.add.assignments <- function(id, user_id, api_token=NULL, company_domain='api', return_type = c('complete','boolean')){
